...
data_path = "/d/hpc/home/mm4195/data/final_data/100k_tsdae-all-MiniLM-L12-v2/corpus.jsonl"
model_names = ["tsdae-all-MiniLM-L12-v2"]
...
def train_with_gpl(model_name):
    ...
    gpl.train(
        path_to_generated_data='/d/hpc/home/mm4195/data/final_data/100k_tsdae-all-MiniLM-L12-v2',
