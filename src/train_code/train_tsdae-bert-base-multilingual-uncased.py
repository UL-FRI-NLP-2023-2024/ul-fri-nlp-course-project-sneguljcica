...
data_path = "/d/hpc/home/mm4195/data/final_data/100k_tsdae-bert-base-multilingual-uncased/corpus.jsonl"
model_names = ["tsdae-bert-base-multilingual-uncased"]
...
def train_with_gpl(model_name):
    ...
    gpl.train(
        path_to_generated_data='/d/hpc/home/mm4195/data/final_data/100k_tsdae-bert-base-multilingual-uncased',
