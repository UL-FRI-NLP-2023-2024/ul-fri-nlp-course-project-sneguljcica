...
data_path = "/d/hpc/home/mm4195/data/final_data/100k_hate_speech_slo/corpus.jsonl"
model_names = ["hate_speech_slo"]
...
def train_with_gpl(model_name):
    ...
    gpl.train(
        path_to_generated_data='/d/hpc/home/mm4195/data/final_data/100k_hate_speech_slo',
