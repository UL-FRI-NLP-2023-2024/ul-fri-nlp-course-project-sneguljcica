#!/bin/sh
#SBATCH --job-name=100k_tsdae-all-MiniLM-L12-v2        # the title of the job
#SBATCH --output=logs_final/100k_tsdae-all-MiniLM-L12-v2.log     # file to which logs are saved
...
srun --nodes=1 --gres=gpu:1 --ntasks=1 --partition=gpu singularity exec --nv ./containers/container-transformers-pytorch-gpu.sif python3 train_code/train_tsdae-all-MiniLM-L12-v2.py
