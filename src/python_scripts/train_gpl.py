...
# Paths
base_path = "/d/hpc/home/mm4195/models/"
data_path = "/d/hpc/home/mm4195/data/raw/corpus.jsonl"
model_names = ["tsdae-bert-base-multilingual-uncased", "tsdae-hate_speech_slo", "tsdae-all-MiniLM-L12-v2" ]
...
def train_with_gpl(model_name):
    ...
    gpl.train(
        path_to_generated_data='/d/hpc/home/mm4195/data/raw',
        base_ckpt=model_path,
        batch_size_gpl=16,
        gpl_steps=140_000,
        output_dir=f'/d/hpc/home/mm4195/models/{model_name}_gpl',
